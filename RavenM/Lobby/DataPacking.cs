...
{
    object ImportNested(ImportDataDelegate importDelegate, string propertyName);

    public void ExportNested(ExportDataDelegate exportDelegate, string propertyName);
}
...
public class GenericNested<T> : TransferableNestedClass where T : new()
{
    ...
    public object ImportNested(ImportDataDelegate importDelegate, string propertyName)
    {
