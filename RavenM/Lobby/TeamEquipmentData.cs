...
namespace RavenM.Lobby
{
    ...
    {
        [DataTransferIgnored]
        public List<int> WeaponHashes {get; set;} = new();

        [DataTransferIgnored]
        public List<int> VehicleIndices {get; set;}  = new();

        [DataTransferIgnored]
        public List<int> TurretIndices {get; set;} = new();
        ...
        {
            get => DataPacking.EncodeToString(WeaponHashes);
            set => WeaponHashes = DataPacking.DecodeFromString<int>(value);
        }
        ...
        public void GetFromGameSettings(int teamIndex, CachedGameData cache)
        {
            ...
            {
                WeaponHashes.Add(weapon.nameHash);
            }
        ...
        public void SetToGameSettings(int teamIndex, CachedGameData cache)
        {
            ...
            foreach (int hash in WeaponHashes)
            {
